                    ...
                    <div class="col-lg-6">
                        <div class="blog-box">
                            <div class="post-media">
                                <a href="{{route('posts.single',['slug'=>$related_post->slug])}}" title="">
                            ...
                            <div class="blog-meta">
                                <h4><a href="{{route('posts.single',['slug'=>$related_post->slug])}}" title="">{{$related_post->title}}</a></h4>
                                <small><a href="{{route('categories.single',['slug'=>$related_post->category->slug])}}" title="">{{$related_post->category->title}}</a></small>
        ...
        <div class="custombox clearfix">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    @endif
                    <form class="form-wrapper comment-form" action="{{route('comments.store')}}" method="post">
                        @csrf
